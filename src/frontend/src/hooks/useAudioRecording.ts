...
const MICROPHONE_IS_MUTED = import.meta.env.VITE_MICROPHONE_IS_MUTED?.toLowerCase() === "true";
...
export const useAudioRecording = () => {
    ...
    const startRecording = useCallback(async (wsManager: WebSocketEventManager) => {
        setIsRecording(true);
